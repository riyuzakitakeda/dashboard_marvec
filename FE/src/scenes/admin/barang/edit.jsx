...
const EditData = ({ id, execute }) => {
    ...
    }, [categories, getDataKategori, dataForm.nama_barang, getDataBarang]);
    ...
    const sendData = useCallback(() => {
        ...
        xhr.open('PUT', process.env.REACT_APP_API_URL + "api/barang/" + id, true); // Send data to API
    ...
    }, [dataForm, execute, fotoBarang, token, id]);
                        ...
                        <Grid container item m={1} spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    value={formatDateForInput(dataForm.waktu_pemeliharaan)}
